...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <ul>
                <li>
                    <a href="https://github.com/davejamesmiller/laravel-breadcrumbs" target="_blank">davejamesmiller/laravel-breadcrumbs</a>
                </li>
            </ul>
        </div>
        ...
        <div class="col-md-6">
            ...
            <ul>
                ...
                <li>
                    <a href="http://codehero.co/series/laravel-4-desde-cero/" target="_blank">Laravel 4 desde Cero</a>
                </li>
                <li>
                    <a href="http://laravel-recipes.com/" target="_blank">Laravel recipes</a>
                </li>
            </ul>
        </div>
    </div>
